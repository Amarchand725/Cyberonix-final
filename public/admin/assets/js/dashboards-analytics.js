...
(function () {
    ...
    // Working Day Summary Chart
    // --------------------------------------------------------------------
    var WorkingDaysSummary = $('#WorkingDaysSummary').data('working-day-summary');
    const WorkingDaysSummaryEl = document.querySelector('#WorkingDaysSummary'),
        WorkingDaysSummaryConfig = {
            chart: {
                height: 130,
                type: 'area',
    ...
    if (typeof WorkingDaysSummarydEl !== undefined && WorkingDaysSummaryEl !== null) {
        const WorkingDaysSummary = new ApexCharts(WorkingDaysSummaryEl, WorkingDaysSummaryConfig);
        WorkingDaysSummary.render();
    }

    // Working Day Summary Chart
    // --------------------------------------------------------------------
    var regularSummary = $('#regularSummary').data('regular-summary');
    const regularSummaryEl = document.querySelector('#regularSummary'),
        regularSummaryConfig = {
            chart: {
                height: 130,
                type: 'area',
                parentHeightOffset: 0,
    ...
    if (typeof regularSummarydEl !== undefined && regularSummaryEl !== null) {
        const regularSummary = new ApexCharts(regularSummaryEl, regularSummaryConfig);
        regularSummary.render();
    }

    // Latein Summary Chart
    // --------------------------------------------------------------------
    var lateinSummary = $('#lateinSummary').data('late-in-summary');
    ...
    // Earlyout Summary Chart
    // --------------------------------------------------------------------
    var earlyOutSummary = $('#EarlyOutSummary').data('early-out-summary');
    const earlyOutSummaryEl = document.querySelector('#EarlyOutSummary'),
        earlyOutSummaryConfig = {
            chart: {
                height: 130,
                type: 'area',
                parentHeightOffset: 0,
    ...
    if (typeof earlyOutSummaryEl !== undefined && earlyOutSummaryEl !== null) {
        const earlyOutSummary = new ApexCharts(earlyOutSummaryEl, earlyOutSummaryConfig);
        earlyOutSummary.render();
    }

    // Half Day Summary Chart
    // --------------------------------------------------------------------
    var halfdaySummary = $('#halfdaySummary').data('half-day-summary');
    ...
    // Absent Summary Chart
    // --------------------------------------------------------------------
    var absent_summary = $('#absentSummary').data('absent-summary');
    ...
    // // Total Available Asset Summary --------------------------------------------------------------------
    // var total_asset_summary = $('#totalAssets').data('asset-summary');
    // const totalAssetEl = document.querySelector('#totalAssets'),
    //     totalAssetConfig = {
    //         chart: {
    //             height: 130,
    //             type: 'area',
    ...
    //         }
    //     };
    // if (totalAssetEl !== null) {
    //     const totalAssetChart = new ApexCharts(totalAssetEl, totalAssetConfig);
    //     totalAssetChart.render();
    // }
    // // Total Available Asset Summary --------------------------------------------------------------------
