                                                        ...
                                                        <tr>
                                                            <td class="pad" style="padding-bottom:10px;width:100%;padding-right:0px;padding-left:0px;">
                                                                <div align="center" class="alignment" style="line-height:10px">
                                                                    <img alt="your-logo" src="{{ asset('public/admin/assets/img/logo/1684880051.png') }}" style="height: auto; display: block; border: 0; max-width: 125px; width: 100%;" title="your-logo" width="125" />
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
