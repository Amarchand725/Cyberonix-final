                ...
                <td>
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-4" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                        <tbody>
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #000;     background: url(https://hr.cyberonix.co/public/admin/email-temp-assets/promotion.gif) #fdc4d5; width: 700px; margin: 0 auto; background-blend-mode: multiply; background-repeat: no-repeat; background-size: cover;" width="700">
                                        <tbody>
                                            <tr>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" class="image_block block-2" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                                                        <tr>
                                                            <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
                                                                <div align="center" class="alignment" style="line-height:10px">
                                                                    <img alt="{{ appName() }}" class="fullWidth" src="{{ asset('public/admin/email-temp-assets/promotion.gif') }}" style="height: auto; opacity:0; display: block; border: 0; max-width: 420px; width: 100%; mix-blend-mode: multiply;" title="{{ appName() }}" width="420" /></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                        ...
                                                        <tr>
                                                            <td class="pad" style="padding-bottom:10px;padding-left:40px;padding-right:40px;padding-top:10px;">
                                                                <div style="color:#191919;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:38px;line-height:150%;text-align:center;mso-line-height-alt:57px;">
                                                                    <p style="margin: 0; word-break: break-word;"><strong><span>Dear {{ $mailData['name'] }}, </span></strong></p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                            ...
                                                            <td class="pad" style="padding-left:20px;padding-right:20px;padding-top:10px;">
                                                                <div style="color:#191919;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:17px;line-height:150%;text-align:left;mso-line-height-alt:25.5px;">
                                                                    <p style="margin: 0; word-break: break-word;">
                                                                        I trust this message finds you well. I am pleased to inform you of an important update regarding your employment with {{ appName() }}. Your hard work, dedication, and valuable contributions have not gone unnoticed, and we are thrilled to recognize your outstanding performance.<br/><br/>
                                                                        After a thorough evaluation and careful consideration of your achievements, we are delighted to offer you permanent employment status with our company. This decision is a testament to your commitment, exceptional work ethic, and the significant value you bring to our organization.<br/><br/>
                                                                        As a permanent employee, you will now enjoy the full benefits and privileges associated with this status. We are excited about the prospect of having you as a long-term member of our team and look forward to witnessing your continued growth and success within the company.<br/><br/>
                                                                        Please take this opportunity to review the updated terms of your employment, including any changes in benefits or responsibilities. If you have any questions or require further clarification, do not hesitate to reach out to the Human Resources department.<br/> <br/>
                                                                        Once again, congratulations on this well-deserved achievement. We are confident that your ongoing contributions will play a vital role in the continued success of our team.<br/><br/>
                                                                        Thank you for your hard work, and we look forward to a bright future together.<br/><br/>
                                                                    </p>
                                                                    <br />
