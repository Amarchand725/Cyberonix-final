                ...
                <div class="card-header d-flex justify-content-between align-items-center row">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <button type="button" id="filter-btn" class="btn btn-primary attendance-filter-btn d-block w-100" data-show-url="{{ route('user.attendance.advance-filter.summary') }}"><i class="fa fa-search me-2"></i> Filter </button>
                        </div>
                    </div>
                </div>
