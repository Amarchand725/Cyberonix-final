...
<input type="hidden" id="page_url" value="{{ route('grievances.myTrashed') }}">
@else
<input type="hidden" id="page_url" value="{{ route('grievances.myGrievance') }}">
@endif
                ...
                <div class="col-md-6">
                    <div class="d-flex justify-content-end align-item-center ">
                        ...
                        <div class="dt-buttons btn-group flex-wrap">
                            <a data-toggle="tooltip" data-placement="top" title="Show All Records" href="{{ route('grievances.myGrievance') }}" class="btn btn-success btn-primary mx-3">
                                <span>
                        ...
                        <div class="dt-buttons flex-wrap">
                            <a data-toggle="tooltip" data-placement="top" title="All Trashed Records" href="{{ route('grievances.myTrashed') }}" class="btn btn-label-danger mx-1">
                                <span>
