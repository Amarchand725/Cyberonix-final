...
<table class="table table-bordered table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                @if(File::exists(public_path('admin/assets/document_attachments/' . $attachment->attachment)))
                <a href="{{route('documents.downloadSingle' , $attachment->id)}}" class="btn btn-sm btn-success"><i class=" tf-icons ti ti-download"></i></a>
                @else
                <span class="badge bg-label-danger">File Not Found</span>
                @endif
            </td>
        </tr>
        @endforeach
