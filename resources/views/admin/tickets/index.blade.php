        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="card mb-4">
                <div class="row">
                    ...
                    @if(empty($url) && !Auth::user()->hasRole('Admin'))
                        <div class="col-md-6">
                    ...
                    <form class="pt-0 fv-plugins-bootstrap5 fv-plugins-framework submitBtnWithFileUpload"  data-method="post" data-modal-id="offcanvasAddAnnouncement" id="create-form" enctype="multipart/form-data" >
                        ...
                        <span id="edit-content">
                            ...
                            <div class="col-12 col-md-12 mt-3">
                                ...
                                <textarea class="form-control" rows="5" name="note" id="note" placeholder="Enter note here">{{ old('note') }}</textarea>
    ...
    <script>
        $(document).ready(function () {
            $('#ticket_category_id').on('change', function(){
                ...
                var categoryName = selectedOption.data('category_name');

                if(categoryName=='IT Rapid Support'){
