...
@section('content')
    ...
    @else
        @if(isset($data))
            <input type="hidden" id="page_url" value="{{ route('admin.team.tickets') }}">
        @else
                            ...
                            <div class="d-flex justify-content-end align-item-center mt-3">
                                @if(empty($data))
                                    <div class="dt-buttons btn-group flex-wrap">
                                        <a data-toggle="tooltip" data-placement="top" title="Show All Records" href="{{ route('admin.team.tickets') }}" class="btn btn-success btn-primary mx-3">
                                            <span>
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center row">
                    ...
                    <div class="col-md-4">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <select class="select2 form-select" id="redirectDropdown" onchange="redirectPage(this)">
                                        ...
                                        @foreach ($data['employees'] as $employee)
                                            <option value="{{ URL::to('admin/team/tickets/'.$employee->slug) }}" {{ $user->slug==$employee->slug?"selected":"" }} >
                        ...
                        @php $url = URL::to('admin/team/tickets') @endphp
                        @include('admin.layouts.employee-dropdown', ['employees' => $data['employees'], 'user' => $user, 'url' => $url, 'type' => 'redirect'])
                    </div>
                </div>
                <hr />
