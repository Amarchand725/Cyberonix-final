<div class="row">
    ...
    <div class="mb-3 col-4">
        ...
        <input type="hidden" name="conversion_amount_hidden" id="conversion_amount_hidden">
        <input type="hidden" name="conversion_rate" id="conversion_rate">
        <div class="fv-plugins-message-container invalid-feedback"></div>
        <span id="currency_error" class="text-danger error"></span>
        <span id="currency_rate_after_conversion" style="font-size: 13px;opacity: .7;"></span>
    </div>
    <div class="col-md-4">
...
<div class="row mt-2">
    <div class="col-md-6">
        ...
        <input type="text" class="form-control" placeholder="Enter vehicle name" id="vehicle" name="vehicle">
        <div class="fv-plugins-message-container invalid-feedback"></div>
        <span id="vehicle_error" class="text-danger error"></span>
    </div>
    <div class="col-md-6">
        <label class="form-label" for="allowance">Allowance</label>
        <input type="text" class="form-control numeric" placeholder="Enter allowance" id="allowance" name="allowance">
        <div class="fv-plugins-message-container invalid-feedback"></div>
