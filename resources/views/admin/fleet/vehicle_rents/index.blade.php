...
@section('content')
    @if(isset($data['vehicles']))
        <input type="hidden" id="page_url" value="{{ route('vehicle_rents.index') }}">
    @else
        <input type="hidden" id="page_url" value="{{ route('vehicle_rents.trashed') }}">
    @endif
                        ...
                        <div class="d-flex justify-content-end align-item-center mt-4">
                            @if(isset($data['vehicles']))
                                <div class="dt-buttons flex-wrap">
                                    <a data-toggle="tooltip" data-placement="top" title="All Trashed Records" href="{{ route('vehicle_rents.trashed') }}" class="btn btn-label-danger mx-1">
                                        <span>
                                ...
                                <div class="dt-buttons btn-group flex-wrap">
                                    <button
                                        data-toggle="tooltip"
                                        data-placement="top"
                                        title="Add Vehicle Rent"
                                        type="button"
                                        class="btn btn-secondary add-new btn-primary mx-3"
                                        id="add-btn"
                                        data-url="{{ route('vehicle_rents.store') }}"
                            ...
                            @else
                                <div class="dt-buttons btn-group flex-wrap">
                                    <a data-toggle="tooltip" data-placement="top" title="Show All Records" href="{{ route('vehicle_rents.index') }}" class="btn btn-success btn-primary mx-3">
                                        <span>
                    ...
                    <form id="create-form" class="row g-3" data-method="" data-modal-id="offcanvasAddAnnouncement">
                        ...
                        <span id="edit-content">
                            ...
                            <div class="col-md-12 mt-2">
                                ...
                                <input type="number" id="rent" name="rent" value="" class="form-control"/>
                                <div class="fv-plugins-message-container invalid-feedback"></div>
