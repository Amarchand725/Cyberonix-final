        ...
        <div class="card mb-4">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-md-4">
                        {{-- <div class="card-header"> --}}
                                <h4 class="fw-bold mb-0"><span class="text-muted fw-light">Home /</span> {{ $title }} / {{ $stationary_category->stationary_category }}</h4>
                        {{-- </div> --}}
                    </div>
                    <div class="col-md-8">
                        <div class="d-flex justify-content-end align-item-center mt-md-0 mt-3">
                            @if(isset($temp))
                                ...
                                <div class="dt-buttons btn-group flex-wrap">
                                    <a href="{{ URL::previous() }}" class="btn btn-primary">
                                        ...
                                        <span class="d-none d-sm-inline-block">Go Back </span>
                                    </a>
                                </div>
                            @else
                                <div class="dt-buttons btn-group flex-wrap">
